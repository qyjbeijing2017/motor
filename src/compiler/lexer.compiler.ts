...
export const TypeFloat64 = createToken({ name: 'TypeFloat64', pattern: /f64/, longer_alt: Identifier });
export const TypeFloat16 = createToken({ name: 'TypeFloat16', pattern: /f16/, longer_alt: Identifier });
export const TypeFloat8 = createToken({ name: 'TypeFloat8', pattern: /f8/, longer_alt: Identifier });
export const TypeFloat32 = createToken({ name: 'TypeFloat32', pattern: /f32/, longer_alt: Identifier });
export const TypeInt64 = createToken({ name: 'TypeInt64', pattern: /i64/, longer_alt: Identifier });
export const TypeInt16 = createToken({ name: 'TypeInt16', pattern: /i16/, longer_alt: Identifier });
export const TypeInt8 = createToken({ name: 'TypeInt8', pattern: /i8/, longer_alt: Identifier });
export const TypeInt32 = createToken({ name: 'TypeInt32', pattern: /i32/, longer_alt: Identifier });
export const TypeUint64 = createToken({ name: 'TypeUint64', pattern: /u64/, longer_alt: Identifier });
export const TypeUint16 = createToken({ name: 'TypeUint16', pattern: /u16/, longer_alt: Identifier });
export const TypeUint8 = createToken({ name: 'TypeUint8', pattern: /u8/, longer_alt: Identifier });
export const TypeUint32 = createToken({ name: 'TypeUint32', pattern: /u32/, longer_alt: Identifier });
